...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast5_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune5Layers_ATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast5_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune5Layers_ATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast5_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune5Layers_ATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast5_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune5Layers_ATTN
