...
#SBATCH --job-name=FinetuneLast25_NoATTN_mv3
#SBATCH --output=logs/FinetuneLast25_NoATTN_mobilenetv3_%j.out

# Configuration: FinetuneLast25_NoATTN - MobileNetV3 only
# Running: 1 backbone × 3 seeds = 3 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast25_NoATTN (MobileNetV3 only)"
...
echo "=========================================="
echo "Job FinetuneLast25_NoATTN (MobileNetV3) completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
