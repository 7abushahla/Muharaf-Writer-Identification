...
#SBATCH --job-name=FinetuneLast1_NoATTN
#SBATCH --output=logs/FinetuneLast1_NoATTN_%j.out

# Configuration: FinetuneLast1_NoATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast1_NoATTN"
...
COMMON_ARGS="\
  --training-mode finetune_last_n --num-trainable-layers 1 \
   \
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast1_NoATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast1_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune1Layers_NoATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast1_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune1Layers_NoATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast1_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune1Layers_NoATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast1_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune1Layers_NoATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneLast1_NoATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
