...
#SBATCH --job-name=FinetuneLast1_ATTN
#SBATCH --output=logs/FinetuneLast1_ATTN_%j.out

# Configuration: FinetuneLast1_ATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast1_ATTN"
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast1_ATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast1_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune1Layers_ATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast1_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune1Layers_ATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast1_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune1Layers_ATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast1_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune1Layers_ATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneLast1_ATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
