...
#SBATCH --job-name=FinetuneLast25_NoATTN
#SBATCH --output=logs/FinetuneLast25_NoATTN_%j.out

# Configuration: FinetuneLast25_NoATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast25_NoATTN"
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast25_NoATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast25_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune25Layers_NoATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast25_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune25Layers_NoATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast25_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune25Layers_NoATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast25_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune25Layers_NoATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneLast25_NoATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
