...
#SBATCH --job-name=FinetuneLast10_NoATTN
#SBATCH --output=logs/FinetuneLast10_NoATTN_%j.out

# Configuration: FinetuneLast10_NoATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast10_NoATTN"
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast10_NoATTN"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Job FinetuneLast10_NoATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
