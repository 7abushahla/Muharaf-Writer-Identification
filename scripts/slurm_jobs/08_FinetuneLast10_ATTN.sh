...
#SBATCH --job-name=FinetuneLast10_ATTN
#SBATCH --output=logs/FinetuneLast10_ATTN_%j.out

# Configuration: FinetuneLast10_ATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast10_ATTN"
...
COMMON_ARGS="\
  --training-mode finetune_last_n --num-trainable-layers 10 \
  --use-attention \
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast10_ATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast10_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune10Layers_ATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast10_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune10Layers_ATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast10_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune10Layers_ATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast10_ATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune10Layers_ATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneLast10_ATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
