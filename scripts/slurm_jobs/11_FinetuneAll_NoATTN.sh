...
#SBATCH --job-name=FinetuneAll_NoATTN
#SBATCH --output=logs/FinetuneAll_NoATTN_%j.out

# Configuration: FinetuneAll_NoATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneAll_NoATTN"
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneAll_NoATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneAll_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune_all_NoATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneAll_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune_all_NoATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneAll_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune_all_NoATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneAll_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune_all_NoATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneAll_NoATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
