...
#SBATCH --job-name=FinetuneLast5_NoATTN
#SBATCH --output=logs/FinetuneLast5_NoATTN_%j.out

# Configuration: FinetuneLast5_NoATTN
# Running: 4 backbones × 3 seeds = 12 total runs

echo "=========================================="
echo "SLURM Job: FinetuneLast5_NoATTN"
...
echo ""
echo "=========================================="
echo "Configuration: FinetuneLast5_NoATTN"
echo "=========================================="
...
echo ""
echo "  Aggregating results for resnet50 - FinetuneLast5_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/resnet50/PgDisj_resnet50_Finetune5Layers_NoATTN
...
echo ""
echo "  Aggregating results for densenet201 - FinetuneLast5_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/densenet201/PgDisj_densenet201_Finetune5Layers_NoATTN
...
echo ""
echo "  Aggregating results for xception - FinetuneLast5_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/xception/PgDisj_xception_Finetune5Layers_NoATTN
...
echo ""
echo "  Aggregating results for mobilenetv3 - FinetuneLast5_NoATTN..."
"$ENV_PY" -u aggregate_results.py Results/mobilenetv3/PgDisj_mobilenetv3_Finetune5Layers_NoATTN
...
echo ""
echo "=========================================="
echo "Job FinetuneLast5_NoATTN completed successfully!"
echo "Finished: $(date)"
echo "=========================================="
